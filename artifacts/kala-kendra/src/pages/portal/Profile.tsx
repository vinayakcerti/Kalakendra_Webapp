...
export default function PortalProfile() {
  ...
  useEffect(() => {
    fetch(`${(import.meta.env.VITE_API_URL ?? "https://kalakendra-api.onrender.com")}/api/portal/me`, { credentials: "include" })
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const res = await fetch(`${(import.meta.env.VITE_API_URL ?? "https://kalakendra-api.onrender.com")}/api/portal/me`, {
        method: "PATCH",
        credentials: "include",
