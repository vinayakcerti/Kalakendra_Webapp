...
import type { FeeWithStudent } from "@workspace/api-client-react";
...
import { CheckCircle2, Clock, AlertCircle, MinusCircle, Trash2, ExternalLink } from "lucide-react";
...
export default function Fees() {
  ...
  function handleSearch(val: string) {
    ...
    (window as unknown as { _feeSearchTimer?: ReturnType<typeof setTimeout> })._feeSearchTimer = setTimeout(() => setDebouncedSearch(val), 300);
  }
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              {statusFilter !== "all" || search
                ...
                : "Add fees to individual students from their student record."}
            </p>
          </div>
        ) : (
